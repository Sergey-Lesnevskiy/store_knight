    ...
    <div class="category-filter">
      <ul class="category-filter__list">
        <li class="category-filter__item">
          <input type="radio" id="weapon" name="type" />
          <label class="btn btn-default" for="weapon">Оружие</label>
        </li>
        <li class="category-filter__item">
          <input type="radio" id="armor" name="type" />
          <label class="btn btn-default" for="armor">Доспехи</label>
        </li>
        <li class="category-filter__item">
          <input type="radio" id="costumes" name="type" />
          <label class="btn btn-default" for="costumes">Костюмы</label>
        </li>
        <li class="category-filter__item">
          <input type="radio" id="jewelry" name="type" />
          <label class="btn btn-default" for="jewelry">Ювелирные украшения </label>
        </li>
        <li class="category-filter__item">
          <input type="radio" id="exotic" name="type" />
          <label class="btn btn-default" for="exotic">Эксклюзивные вещи</label>
        </li>
      </ul>
    </div>
      ...
      <div class="page__right-side">
        ...
        <section class="store">
          <div class="store__item item">
            ...
            <div class="item__title">Кольчуга клёпаная<br>10 мм. (АК)</div>
            <div class="item__stock">В наличии: <span>12</span></div>
