...
export class CartPage extends Page{
  private  containerCard: HTMLElement | null = document.querySelector('.shopping-cart__content')
static TextObject = {
                ...
                <div class="shopping-cart__description">
                    <div class="shopping-cart__description-conteiner">
                        <div class="shopping-cart__description-wrapper">
                            <p class="shopping-cart__description-title">Пулены высокие (ОСОК)</p>
                            <p class="shopping-cart__description-article"> Артикул: (ГК)3021</p>
                    ...
                    <div class="shopping-cart__price-wrapper">
                        ...
                        <div class="shopping-cart__price-total-bold">
                            <span class="shopping-cart__price-">10560</span>
